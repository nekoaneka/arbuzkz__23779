        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                @if(\Cart::getTotalQuantity()>0)
                    <h4>{{ \Cart::getTotalQuantity()}} Продукт(ов) в вашей картине</h4><br>
                @else
                    <div style="margin-left: 200px;">
                        <h4 class="mt-2">Ваша Корзина Пуста</h4><br>
                        <a href="/" class="btn btn-dark ml-3">Продолжить Покупку</a>
                    </div>
                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <p>
                                ...
                                <b>Цена: </b>{{ $item->price }} тг<br>
                                <b>Итого: </b>{{ \Cart::get($item->id)->getPriceSum() }} тг<br>
                ...
                <div class="col-lg-5">
                    <div class="card">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><b>Сумма: </b>{{ \Cart::getTotal() }} тг</li>
                        </ul>
                    </div>
                    <br><a href="/" class="btn btn-dark">Продолжить покупку</a>
                    <a href="{{ route('checkout.index') }}" class="btn btn-success">Перейти к оплате</a>
                </div>
            @endif
        </div>
        <br><br>
